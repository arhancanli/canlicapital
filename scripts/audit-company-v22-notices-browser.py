"""Grouped v22 source-notice interaction and layout checks; not a whole-corpus audit."""
import hashlib
import json
...
report = dict(schema='canli.v22-notice-browser.v1', publication_approved=False,
                ...
                for width in [390, 1440]:
                    ...
                    for path, notice in paths:
                        ...
                        if path == '/companies/0001425205':
                            ...
                            expected = sorted((r['observation'].get('start', 'At date'), r['observation']['end'], str(r['observation']['val']), r['observation']['unit'], r['observation']['accn'], r['filing_url']) for r in record['editorial_exclusions'])
                            ...
                            assert actual == expected, 'Withheld observation/source mismatch'
