...
const [catalogDir, deliveryDir, distDir, output] = process.argv.slice(2);
if (!output) throw new Error('Usage: node scripts/measure-company-delivery.mjs CATALOG DELIVERY DIST REPORT');
const app = companyPreviewServer({ catalogDir, deliveryDir, distDir });
