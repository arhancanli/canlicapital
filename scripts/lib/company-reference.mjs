import { EDITORIAL_POLICY_V23, EDITORIAL_EXCLUSIONS_V23, EDITORIAL_OBSERVATION_EXCLUSIONS_V23 } from './company-editorial-v23.mjs';
import { EXPANDED_CONCEPTS_V23 } from './company-expanded-concepts-v23.mjs';
import { EDITORIAL_POLICY_V22, EDITORIAL_EXCLUSIONS_V22, EDITORIAL_OBSERVATION_EXCLUSIONS_V22 } from './company-editorial-v22.mjs';
import { EDITORIAL_POLICY_V21, EDITORIAL_EXCLUSIONS_V21, EDITORIAL_OBSERVATION_EXCLUSIONS_V21 } from './company-editorial-v21.mjs';
import { EDITORIAL_POLICY_V20, EDITORIAL_EXCLUSIONS_V20, EDITORIAL_OBSERVATION_EXCLUSIONS_V20 } from './company-editorial-v20.mjs';
import { EDITORIAL_POLICY_V19, EDITORIAL_EXCLUSIONS_V19, EDITORIAL_OBSERVATION_EXCLUSIONS_V19 } from './company-editorial-v19.mjs';
import { EDITORIAL_POLICY_V18, EDITORIAL_EXCLUSIONS_V18, EDITORIAL_OBSERVATION_EXCLUSIONS_V18 } from './company-editorial-v18.mjs';
import { EDITORIAL_POLICY_V17, EDITORIAL_EXCLUSIONS_V17, EDITORIAL_OBSERVATION_EXCLUSIONS_V17 } from './company-editorial-v17.mjs';
import { EDITORIAL_POLICY_V16, EDITORIAL_EXCLUSIONS_V16, EDITORIAL_OBSERVATION_EXCLUSIONS_V16 } from './company-editorial-v16.mjs';
import { EDITORIAL_POLICY_V15, EDITORIAL_EXCLUSIONS_V15, EDITORIAL_OBSERVATION_EXCLUSIONS_V15 } from './company-editorial-v15.mjs';
import { EDITORIAL_POLICY_V14, EDITORIAL_EXCLUSIONS_V14, EDITORIAL_OBSERVATION_EXCLUSIONS_V14 } from './company-editorial-v14.mjs';
import { EDITORIAL_POLICY_V13, EDITORIAL_EXCLUSIONS_V13, EDITORIAL_OBSERVATION_EXCLUSIONS_V13 } from './company-editorial-v13.mjs';
import { EDITORIAL_POLICY_V12, EDITORIAL_EXCLUSIONS_V12, EDITORIAL_OBSERVATION_EXCLUSIONS_V12 } from './company-editorial-v12.mjs';
...
import { EDITORIAL_POLICY_V7, EDITORIAL_EXCLUSIONS_V7 } from './company-editorial-v7.mjs';
import { EDITORIAL_POLICY_V6, EDITORIAL_EXCLUSIONS_V6 } from './company-editorial-v6.mjs';
...
export function companyReference(raw, { fetchedAt, expectedCik, diagnostics = {}, selectionPolicy }) {
  ...
  const decisions = selectionPolicy === EDITORIAL_POLICY_V23 ? EDITORIAL_EXCLUSIONS_V23 : selectionPolicy === EDITORIAL_POLICY_V22 ? EDITORIAL_EXCLUSIONS_V22 : selectionPolicy === EDITORIAL_POLICY_V21 ? EDITORIAL_EXCLUSIONS_V21 : selectionPolicy === EDITORIAL_POLICY_V20 ? EDITORIAL_EXCLUSIONS_V20 : selectionPolicy === EDITORIAL_POLICY_V19 ? EDITORIAL_EXCLUSIONS_V19 : selectionPolicy === EDITORIAL_POLICY_V18 ? EDITORIAL_EXCLUSIONS_V18 : selectionPolicy === EDITORIAL_POLICY_V17 ? EDITORIAL_EXCLUSIONS_V17 : selectionPolicy === EDITORIAL_POLICY_V16 ? EDITORIAL_EXCLUSIONS_V16 : selectionPolicy === EDITORIAL_POLICY_V15 ? EDITORIAL_EXCLUSIONS_V15 : selectionPolicy === EDITORIAL_POLICY_V14 ? EDITORIAL_EXCLUSIONS_V14 : selectionPolicy === EDITORIAL_POLICY_V13 ? EDITORIAL_EXCLUSIONS_V13 : selectionPolicy === EDITORIAL_POLICY_V12 ? EDITORIAL_EXCLUSIONS_V12 : selectionPolicy === EDITORIAL_POLICY_V11 ? EDITORIAL_EXCLUSIONS_V11 : selectionPolicy === EDITORIAL_POLICY_V10 ? EDITORIAL_EXCLUSIONS_V10 : selectionPolicy === EDITORIAL_POLICY_V9 ? EDITORIAL_EXCLUSIONS_V9 : selectionPolicy === EDITORIAL_POLICY_V8 ? EDITORIAL_EXCLUSIONS_V8 : selectionPolicy === EDITORIAL_POLICY_V7 ? EDITORIAL_EXCLUSIONS_V7 : selectionPolicy === EDITORIAL_POLICY_V6 ? EDITORIAL_EXCLUSIONS_V6 : selectionPolicy === EDITORIAL_POLICY_V5 ? EDITORIAL_EXCLUSIONS_V5 : selectionPolicy === EDITORIAL_POLICY_V4 ? EDITORIAL_EXCLUSIONS_V4 : selectionPolicy === EDITORIAL_POLICY_V3 ? EDITORIAL_EXCLUSIONS_V3 : selectionPolicy === EDITORIAL_POLICY ? EDITORIAL_EXCLUSIONS : [];
  const observationDecisions = selectionPolicy === EDITORIAL_POLICY_V23 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V23 : selectionPolicy === EDITORIAL_POLICY_V22 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V22 : selectionPolicy === EDITORIAL_POLICY_V21 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V21 : selectionPolicy === EDITORIAL_POLICY_V20 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V20 : selectionPolicy === EDITORIAL_POLICY_V19 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V19 : selectionPolicy === EDITORIAL_POLICY_V18 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V18 : selectionPolicy === EDITORIAL_POLICY_V17 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V17 : selectionPolicy === EDITORIAL_POLICY_V16 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V16 : selectionPolicy === EDITORIAL_POLICY_V15 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V15 : selectionPolicy === EDITORIAL_POLICY_V14 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V14 : selectionPolicy === EDITORIAL_POLICY_V13 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V13 : selectionPolicy === EDITORIAL_POLICY_V12 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V12 : selectionPolicy === EDITORIAL_POLICY_V11 ? EDITORIAL_OBSERVATION_EXCLUSIONS_V11 : [];
  const sourceHash = createHash('sha256').update(raw).digest('hex');
  const definitions = [EXTENDED_POLICY, EDITORIAL_POLICY, EDITORIAL_POLICY_V3, EDITORIAL_POLICY_V4, EDITORIAL_POLICY_V5, EDITORIAL_POLICY_V6, EDITORIAL_POLICY_V7, EDITORIAL_POLICY_V8, EDITORIAL_POLICY_V9, EDITORIAL_POLICY_V10, EDITORIAL_POLICY_V11, EDITORIAL_POLICY_V12, EDITORIAL_POLICY_V13, EDITORIAL_POLICY_V14, EDITORIAL_POLICY_V15, EDITORIAL_POLICY_V16, EDITORIAL_POLICY_V17, EDITORIAL_POLICY_V18, EDITORIAL_POLICY_V19, EDITORIAL_POLICY_V20, EDITORIAL_POLICY_V21, EDITORIAL_POLICY_V22, EDITORIAL_POLICY_V23].includes(selectionPolicy) ? (selectionPolicy === EDITORIAL_POLICY_V23 ? { ...CONCEPTS, ...EXTENDED_CONCEPTS, ...EXPANDED_CONCEPTS_V23 } : { ...CONCEPTS, ...EXTENDED_CONCEPTS }) : CONCEPTS;
  for (const [tag, definition] of Object.entries(definitions)) {
    ...
    if (Object.hasOwn(EXTENDED_CONCEPTS, tag) || Object.hasOwn(EXPANDED_CONCEPTS_V23, tag)) {
