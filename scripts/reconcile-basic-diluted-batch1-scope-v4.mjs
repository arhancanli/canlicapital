...
assert.equal(activeReviewed, 50); assert.equal(withdrawn, 8); assert.equal(pending, 1118);
const result = {
  schema: 'canli.basic-diluted-batch1-scope.v4', publication_approved: false,
