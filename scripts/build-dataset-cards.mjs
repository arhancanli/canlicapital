...
${summary.gold_packet_items} items stratified by template; [the annotation guidelines](${REPO}/blob/main/scripts/datasets/filing-facts/ANNOTATION_GUIDELINES.md)
