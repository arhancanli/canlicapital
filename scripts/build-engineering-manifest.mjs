...
const MEASURED = {
  ...
  "canli-backtest": {
    ...
    benchmark: {
      ...
      rows: [
        ["PBO via CSCV, 2,000 x 100 configs, 5,000 sampled splits", "1.55 s"],
        ["Deflated Sharpe, 1,260 daily returns", "289 microseconds"],
        ["PBO measured on pure noise (0.5 is correct)", "0.569"],
        ["Sharpe +1.139 deflated at 200 trials", "0.000"],
      ],
    },
  },
};
