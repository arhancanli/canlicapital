"""Compare priority editorial observations to captured inline facts; retain gaps."""
import argparse
import hashlib
import json
...
report = {'schema': 'canli.editorial-inline-comparison.v1',
          ...
          'claim_boundary': 'Latest-selected priority editorial observations only. Matches enforce entity, period, unit, value, scale/sign, and exclude dimensional/nil contexts. Unsupported formats or unmatched rows remain unresolved; numerical equality alone does not establish concept scope or all-history accuracy.'}
