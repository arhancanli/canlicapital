...
assert.equal(activeReviewed, 14); assert.equal(withdrawn, 8); assert.equal(pending, 1154);
const result = {
  schema: 'canli.basic-diluted-batch1-scope.v2', publication_approved: false,
