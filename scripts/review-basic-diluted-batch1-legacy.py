...
def main():
    ...
    helper_path = ROOT / 'scripts/review-basic-diluted-legacy.py'
    ...
    result = dict(schema='canli.basic-diluted-batch1-legacy.v1', publication_approved=False,
