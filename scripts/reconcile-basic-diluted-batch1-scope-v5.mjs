...
assert.equal(activeReviewed, 66); assert.equal(withdrawn, 8); assert.equal(pending, 1102);
const result = {
  schema: 'canli.basic-diluted-batch1-scope.v5', publication_approved: false,
