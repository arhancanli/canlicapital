...
pdftitle={Point-in-Time Macroeconomic Trend: Seven Identities Without a Validated Sleeve},pdfauthor={Arhan Canli}}
\title{Point-in-Time Macroeconomic Trend: Seven Identities Without a Validated Sleeve}
