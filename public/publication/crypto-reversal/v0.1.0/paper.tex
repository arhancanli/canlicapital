...
pdftitle={Crypto Short-Horizon Reversal: Two Decisive Negative Trials},pdfauthor={Arhan Canli}}
\title{Crypto Short-Horizon Reversal: Two Decisive Negative Trials}
