...
| Release checks | Scope-v19 HTTP17917 passed for all 90,732 pages and 6,646 downloads. Browser26941 passed 900 cases, including 980 exact note/source checks. Scope-v22 browser39143 is running; archive12864 restored all34 reports. Scope-v20 browser86426 passed940 historical cases. | Complete hosted routing, storage, load/cost and failure-behavior gates. |
...
| Evidence retention | Full v22 runtime and batch1/scope supplements restored locally. Latest sealed batch2 scope-v22 archive12864 restored all34 reports from693 files, including all nine pending reports. | Offsite backup, ongoing maintenance and coverage for subsequent changes. Local restore is not independent certification. |
...
`artifacts/seo/company-batch2-evidence-archive-scope-v22-20260921.json`;
