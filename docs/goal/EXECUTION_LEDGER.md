...
| Release checks | Scope-v28 HTTP passed all90,732 pages/6,646 downloads; archive restored43 reports. Clean hosted preview passed32 browser cases/four navigation flows but fails seven download readiness checks while transfer is incomplete. Full scope-v28 local browser96813 passed1,336 cases/1,480 note-source checks. Scope-v29 archive now reproduced45 reports; scope-v29 browser37320 and HTTP95414 audits running. | Complete current browser audit, storage, hosted downloads, cloud-load/cost and failure gates. |
...
| Evidence retention | Full v22 runtime and batch1/scope supplements restored locally. Latest sealed batch2 scope-v28 archive70654 restored all43 reports from736 files, including all eleven pending reports. | Offsite backup, ongoing maintenance and coverage for subsequent changes. Local restore is not independent certification. |
| Editorial review | Batch1: 1,148 reviewed (130 presentation-only), 28 withdrawn, none pending. Batch2: 616 reviewed (80 presentation-only), 184 pending, none withdrawn. Eleven discrepancy/hidden-mapping/reconciliation reports remain pending, including Raphael sign presentation and Vyome two-class numerator. | Resolve or retain unresolved scope honestly; continue broader source/usefulness review. |
...
`artifacts/seo/company-batch2-evidence-archive-scope-v28-20260921.json`;
