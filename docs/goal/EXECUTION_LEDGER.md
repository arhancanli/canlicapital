...
| Release checks | Scope-v28 HTTP passed all90,732 pages/6,646 downloads; archive restored43 reports. Clean hosted preview passed32 browser cases/four navigation flows but fails seven download readiness checks while transfer is incomplete. Full scope-v28 local browser96813 passed1,336 cases/1,480 note-source checks. Later scope-v29 notes need relevant checks/archive coverage. | Complete current browser audit, storage, hosted downloads, cloud-load/cost and failure gates. |
