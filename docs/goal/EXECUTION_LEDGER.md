...
|T06 Storage and release |Runtime plan and local restore verified; access pending |New6,249objects/828,366,117bytes plan;earlier7,843-file archive covers only priorcohorts;updated archive and remote/hosted verification pending |
