...
| Release checks | Scope-v19 HTTP17917 passed for all 90,732 pages and 6,646 downloads. Browser26941 passed 900 cases, including 980 exact note/source checks. Scope-v20 browser86426 is running; archive20482 restored all30 reports. | Complete hosted routing, storage, load/cost and failure-behavior gates. |
