...
| Release checks | Scope-v25 HTTP39340 passed for all 90,732 pages and 6,646 downloads; archive57809 restored38 reports. Scope-v25 browser36742 passed1,200 cases/1,340 exact note-source checks. Current preview is READY but hosted readiness fails seven download checks while storage is incomplete. Later scope-v26 notes and pending report need relevant checks/archive coverage. | Complete hosted routing, storage, load/cost and failure-behavior gates. |
...
| Editorial review | Batch1: 1,148 reviewed (130 presentation-only), 28 withdrawn, none pending. Batch2: 552 reviewed (72 presentation-only), 248 pending, none withdrawn. Ten discrepancy/hidden-mapping reports remain pending, including Raphael positive EPS tags versus visible loss parentheses. | Resolve or retain unresolved scope honestly; continue broader source/usefulness review. |
