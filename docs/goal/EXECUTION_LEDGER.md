...
| Release checks | Scope-v28 HTTP passed all90,732 pages/6,646 downloads; archive restored43 reports. Clean hosted preview passed32 browser cases/four navigation flows but fails seven download readiness checks while transfer is incomplete. Full local browser96813 remains running; prior scope-v25 passed1,200 cases. | Complete current browser audit, storage, hosted downloads, cloud-load/cost and failure gates. |
