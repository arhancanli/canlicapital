...
| Indexing and SEO | Live sitemap index with stable children (site 263, 19 company shards = 916,471 URLs) since the v27 activation of September 23. IndexNow submits deltas only (102,521 accepted on September 23 by the hourly deploy after v27). Last confirmed Google indexing: 262 pages as of September 14. | Search Console resubmission by the owner, then crawl/index measurement by family; at least 800,000 actually indexed canonical pages, targeting one million. |
| Relevant content coverage | Last recorded inventory: 8,031 discovered issuers and 104 intent owners. Staged, not live: v23 (156,714 admissible), v25 = expanded concepts + filing family (556,677 admissible); v26 = v25 + 3,810 historical filers (813,892 admissible); v27 = v26 + 2,552 historical filers (916,208 admissible, 391,891 filing pages); flag decision of September 22 applied. Existing coverage cannot support the indexing goal alone. | Expand useful, distinct, supportable source/content families and relevant search intents. |
