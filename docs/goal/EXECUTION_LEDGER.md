...
| Release checks | Scope-v19 HTTP17917 passed for all 90,732 pages and 6,646 downloads. Browser26941 passed 900 cases, including 980 exact note/source checks. Scope-v20 browser86426 passed940 cases; archive20482 restored all30 reports. Later Myomo pending report and scope-v21 notes need archive coverage; scope-v21 notes await relevant release checks. | Complete hosted routing, storage, load/cost and failure-behavior gates. |
...
| Editorial review | Batch1: 1,148 reviewed (130 presentation-only), 28 withdrawn, none pending. Batch2: 432 reviewed (64 presentation-only), 368 pending, none withdrawn. Eight discrepancy reports remain pending, including Myomo. | Resolve or retain unresolved scope honestly; continue broader source/usefulness review. |
