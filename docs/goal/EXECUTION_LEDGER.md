...
| Relevant content coverage | Last recorded inventory: 8,031 discovered issuers and 104 intent owners. Staged, not live: v23 (132,876 admissible), v25 = expanded concepts + filing family (508,158 admissible, 256,726 filing pages). Existing coverage cannot support the indexing goal alone. | Expand useful, distinct, supportable source/content families and relevant search intents. |
| Developer platform | MCP 0.1.2 published (174 npm downloads September 14 to 20); 0.2.0 candidate with company_financial_history open in PR175; GitHub release v0.2.0 and 18 repository topics; both repositories 0 stars on September 21. | Owner publishes 0.2.0; substantive releases; weekly star and download measurement. |
