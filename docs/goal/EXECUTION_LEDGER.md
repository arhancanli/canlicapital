...
| Release checks | Scope-v25 HTTP39340 passed for all 90,732 pages and 6,646 downloads; archive57809 restored38 reports. Scope-v25 browser36742 passed1,200 cases/1,340 exact note-source checks. Current preview is READY but hosted readiness fails seven download checks while storage is incomplete. Later scope-v26–28 notes and pending reports need relevant checks/archive coverage. | Complete hosted routing, storage, load/cost and failure-behavior gates. |
...
| Evidence retention | Full v22 runtime and batch1/scope supplements restored locally. Latest sealed batch2 scope-v25 archive57809 restored all38 reports from714 files, including all nine pending reports. | Offsite backup, ongoing maintenance and coverage for subsequent changes. Local restore is not independent certification. |
| Editorial review | Batch1: 1,148 reviewed (130 presentation-only), 28 withdrawn, none pending. Batch2: 592 reviewed (72 presentation-only), 208 pending, none withdrawn. Eleven discrepancy/hidden-mapping/reconciliation reports remain pending, including Raphael sign presentation and Vyome two-class numerator. | Resolve or retain unresolved scope honestly; continue broader source/usefulness review. |
...
`artifacts/seo/company-batch2-evidence-archive-scope-v25-20260921.json`;
