...
| Release checks | Scope-v19 HTTP17917 passed for all 90,732 pages and 6,646 downloads. Browser26941 passed 900 cases, including 980 exact note/source checks. Scope-v20 browser86426 passed940 cases; archive20482 restored all30 reports. Later Myomo/Fuwei pending reports and scope-v21/22 notes need archive coverage; new notes await relevant release checks. | Complete hosted routing, storage, load/cost and failure-behavior gates. |
...
| Evidence retention | Full v22 runtime and batch1/scope supplements restored locally. Latest sealed batch2 scope-v20 archive20482 restored all30 reports from674 files, including seven historical pending discrepancies. | Offsite backup, ongoing maintenance and coverage for subsequent changes. Local restore is not independent certification. |
| Editorial review | Batch1: 1,148 reviewed (130 presentation-only), 28 withdrawn, none pending. Batch2: 448 reviewed (64 presentation-only), 352 pending, none withdrawn. Nine discrepancy/hidden-mapping reports remain pending, including Fuwei. | Resolve or retain unresolved scope honestly; continue broader source/usefulness review. |
...
`artifacts/seo/company-batch2-evidence-archive-scope-v20-20260921.json`;
