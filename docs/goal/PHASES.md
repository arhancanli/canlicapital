...
| 3 | Serving and discovery at corpus scale | Combined v22:90,732 candidate URLs; scope-v28 full HTTP and43-report archive passed; clean hosted browser passed32 cases; full local browser running; v22 transfer44227 stopped on520; recovery79720 running, production pending | Durable catalog/storage, cached rendering, real 404s, bounded directories/sitemaps, measured load/cost/freshness and failure behavior |
