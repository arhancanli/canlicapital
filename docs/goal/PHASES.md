...
| 3 | Serving and discovery at corpus scale | Combined v22:90,732 candidate URLs; fresh90,732page HTTP/600browser cases and isolated restore passed; v22 hosted transfer44227 running, production pending | Durable catalog/storage, cached rendering, real 404s, bounded directories/sitemaps, measured load/cost/freshness and failure behavior |
