...
| 5 | Grow useful corpus toward 10k, 100k, 300k, 800k and 1m indexed pages | Baseline 262 indexed as of September 14; 77,622 URLs live and submitted; v23 staged with 132,876 admitted URLs (upload running); v25 (expanded concepts + filing family) staged with 508,158 admitted URLs, not uploaded or live | Source and editorial gates at each stage, actual indexed counts and quality monitoring by family |
