...
| 1 | Source-selection correctness, bulk corpus audit and durable candidate catalog | 342 fresh captures complete; core and extended policies reproduced; full corpus incomplete | Production selector reused; rejected/conflicting inputs tested; atomic catalog; real corpus size reported without extrapolation |
...
| 3 | Serving and discovery at corpus scale | Ranked directories; core 3,057 and extended 9,386-URL staged sitemaps verified; production integration/activation pending | Durable catalog/storage, cached rendering, real 404s, bounded directories/sitemaps, measured load/cost/freshness and failure behavior |
