...
| 1 | Source-selection correctness, bulk corpus audit and durable candidate catalog | Five cohorts replayed under v14; priority600reviewed/10withdrawn; broader scope open | Production selector reused; rejected/conflicting inputs tested; atomic catalog; real corpus size reported without extrapolation |
...
| 3 | Serving and discovery at corpus scale | Combinedv14:90,736 unique candidate URLs across five cohorts; hosted transfer/production pending | Durable catalog/storage, cached rendering, real 404s, bounded directories/sitemaps, measured load/cost/freshness and failure behavior |
| 4 | Release verified initial expansion and establish search measurements | Static327URL release and API revocation deployed/verified in production; company hosted storage pending | Passing release checks, verified production behavior, Search Console evidence, measured crawl/index exclusions |
