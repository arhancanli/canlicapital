...
| 3 | Serving and discovery at corpus scale | Combinedv9:90,738 unique candidate URLs across five cohorts; hosted transfer/production pending | Durable catalog/storage, cached rendering, real 404s, bounded directories/sitemaps, measured load/cost/freshness and failure behavior |
