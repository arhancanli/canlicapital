...
| 3 | Serving and discovery at corpus scale | Combined v22:90,732 candidate URLs; scope-v25 90,732page HTTP,1,200browser cases and38-report isolated restore passed; v22 transfer44227 stopped on520; recovery79720 running, production pending | Durable catalog/storage, cached rendering, real 404s, bounded directories/sitemaps, measured load/cost/freshness and failure behavior |
| 4 | Release verified initial expansion and establish search measurements | Static327URL release and API revocation deployed/verified in production; current noindex preview built; downloads503 while hosted storage incomplete | Passing release checks, verified production behavior, Search Console evidence, measured crawl/index exclusions |
