...
| 5 | Grow useful corpus toward 10k, 100k, 300k, 800k and 1m indexed pages | Baseline 262 indexed as of September 14; 556,940 URLs live and submitted (v25); v26 (historical filers) staged with 813,892 admitted URLs, upload running | Source and editorial gates at each stage, actual indexed counts and quality monitoring by family |
