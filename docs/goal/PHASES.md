...
| 3 | Serving and discovery at corpus scale | Combined v22:90,732 candidate URLs; full local HTTP audit passed; hosted transfer/production pending | Durable catalog/storage, cached rendering, real 404s, bounded directories/sitemaps, measured load/cost/freshness and failure behavior |
