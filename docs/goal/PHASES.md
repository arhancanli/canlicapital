...
| 3 | Serving and discovery at corpus scale | Correctedv3:54,416 URLs replayed across three cohorts; hosted storage/production pending | Durable catalog/storage, cached rendering, real 404s, bounded directories/sitemaps, measured load/cost/freshness and failure behavior |
