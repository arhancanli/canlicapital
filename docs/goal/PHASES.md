...
| 3 | Serving and discovery at corpus scale | Combined v22:90,732 candidate URLs; scope-v19 90,732page HTTP/900browser cases and isolated restore passed; v22 transfer44227 stopped on520; recovery79720 running, production pending | Durable catalog/storage, cached rendering, real 404s, bounded directories/sitemaps, measured load/cost/freshness and failure behavior |
