...
| 1 | Source-selection correctness, bulk corpus audit and durable candidate catalog | 342 original plus853 second and766 third eligible captures replayed; fourth683 staged separately; exclusions retained; full corpus incomplete | Production selector reused; rejected/conflicting inputs tested; atomic catalog; real corpus size reported without extrapolation |
...
| 3 | Serving and discovery at corpus scale | Combinedv10:90,737 unique candidate URLs across five cohorts; hosted transfer/production pending | Durable catalog/storage, cached rendering, real 404s, bounded directories/sitemaps, measured load/cost/freshness and failure behavior |
