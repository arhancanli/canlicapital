...
| 1 | Source-selection correctness, bulk corpus audit and durable candidate catalog | 342 fresh captures complete; 2,987 staged candidates reproduced; full corpus blocked | Production selector reused; rejected/conflicting inputs tested; atomic catalog; real corpus size reported without extrapolation |
...
| 3 | Serving and discovery at corpus scale | 3,057 staged HTML pages and 698 downloads verified; production storage/discovery activation pending | Durable catalog/storage, cached rendering, real 404s, bounded directories/sitemaps, measured load/cost/freshness and failure behavior |
