...
| 3 | Serving and discovery at corpus scale | Combined v22:90,732 candidate URLs; scope-v28 full HTTP and43-report archive passed; clean hosted browser passed32 cases; scope-v28 local browser passed1,336 cases; scope-v29 archive reproduced45 reports, current browser/HTTP checks running; v22 transfer44227 stopped on520; recovery79720 running, production pending | Durable catalog/storage, cached rendering, real 404s, bounded directories/sitemaps, measured load/cost/freshness and failure behavior |
