...
| 5 | Grow useful corpus toward 10k, 100k, 300k, 800k and 1m indexed pages | Baseline 262 indexed as of September 14; 156,977 URLs live and submitted (v23); v25 (expanded concepts + filing family) staged with 556,677 admitted URLs, upload running | Source and editorial gates at each stage, actual indexed counts and quality monitoring by family |
