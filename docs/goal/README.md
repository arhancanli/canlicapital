...
- Website: `/Users/arhancanli/canlicapital-expansion-20260919`, branch `evidence/share-context-batch32-20260921`. PR99 merged; v19selector comparison preserves3,323companies/87,344histories. Latest built runtime remainsv14at90,736candidate URLs. Batch1archive446files/six reports restored; v17two Siebert holds added; batch1 scope890reviewed (96presentation-only)/266pending/20withdrawn; no uploader. Production uses the clean canlicapital-production-20260920 checkout at9608542c. Read STATUS for exact current evidence and next action.
