...
- Website: `/Users/arhancanli/canlicapital-expansion-20260919`, branch `evidence/iovance-older-share-scope-20260921`. PR115 merged; v22 adds eight older Iovance holds, full-corpus comparison running. Latest built runtime remainsv14at90,736candidate URLs. Batch1archive446files/six reports restored; v17two Siebert holds added; batch1 scope1148reviewed (130presentation-only)/0pending/28withdrawn; no uploader. Production uses the clean canlicapital-production-20260920 checkout at9608542c. Read STATUS for exact current evidence and next action.
