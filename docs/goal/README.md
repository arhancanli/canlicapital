...
- Website: `/Users/arhancanli/canlicapital-expansion-20260919`, branch `evidence/basic-diluted-batch1-archive-20260920`. PR56 merged; v16selector comparison preserves3,323companies/87,344histories. Latest built runtime remainsv14at90,736candidate URLs. Batch1archive446files/six reports restored; scope review open; no uploader. Production uses the clean canlicapital-production-20260920 checkout at9608542c. Read STATUS for exact current evidence and next action.
