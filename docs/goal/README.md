...
- Website: `/Users/arhancanli/canlicapital-expansion-20260919`, branch `evidence/runtime-v22-20260921`. PR117 merged; v22 full-corpus comparison verifies3,323companies/87,342histories with eight older Iovance holds. Latest built runtime v22 has90,732candidate URLs; local full HTTP audit31666 is running. Batch1archive446files/six reports restored; v22scope supplement835files/61outputs restored; v17two Siebert holds added; batch1 scope1148reviewed (130presentation-only)/0pending/28withdrawn; no uploader. Production uses the clean canlicapital-production-20260920 checkout at9608542c. Read STATUS for exact current evidence and next action.
