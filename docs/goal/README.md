...
- Website: `/Users/arhancanli/canlicapital-expansion-20260919`, branch `evidence/rewalk-historical-context-20260921`. PR111 merged; v20full-corpus comparison preserves3,323companies/87,344histories. Latest built runtime remainsv14at90,736candidate URLs. Batch1archive446files/six reports restored; v17two Siebert holds added; batch1 scope1092reviewed (118presentation-only)/58pending/26withdrawn; no uploader. Production uses the clean canlicapital-production-20260920 checkout at9608542c. Read STATUS for exact current evidence and next action.
