...
- Website: `/Users/arhancanli/canlicapital-expansion-20260919`, branch `evidence/share-context-batch7-20260920`. PR70 merged; v17selector comparison preserves3,323companies/87,344histories. Latest built runtime remainsv14at90,736candidate URLs. Batch1archive446files/six reports restored; v17two Siebert holds added; batch1 scope298reviewed (48presentation-only)/870pending/8withdrawn; no uploader. Production uses the clean canlicapital-production-20260920 checkout at9608542c. Read STATUS for exact current evidence and next action.
