...
| `measurements/*.html` | 85 generated Dataset pages with explicit claim boundaries |
...
235 canonical URLs in the sitemap (all indexable), plus a public noindex evidence page for every incomplete registered
