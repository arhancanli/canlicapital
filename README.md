...
| `research/*.html` | 109 generated technical reports, each with Scholar metadata and BibTeX |
...
238 canonical URLs in the sitemap (all indexable), plus a public noindex evidence page for every incomplete registered
