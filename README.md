...
| `research/*.html` | 113 generated technical reports, each with Scholar metadata and BibTeX |
...
329 canonical URLs in the sitemap (all indexable), plus a public noindex evidence page for every incomplete registered
